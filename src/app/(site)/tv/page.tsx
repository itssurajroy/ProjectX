...
import { Tv, Sparkles, Filter, ChevronLeft, ChevronRight } from 'lucide-react';
...
function TVShowsFilter({ onFilterChange, initialFilters }: { onFilterChange: (filters: any) => void; initialFilters: any; }) {
    ...
    <>
      <div className="relative h-[50vh] md:h-[60vh] flex items-center justify-center text-center overflow-hidden -mt-16">
        <div className="absolute inset-0 z-0">
            <Image src="https://picsum.photos/seed/tv-hero/1920/1080" data-ai-hint="epic tv series cinematic" alt="TV Shows Background" fill priority className="object-cover opacity-20 blur-sm scale-110" />
        ...
        >
            ...
            {totalAnimes > 0 && (
                ...
                <strong>{totalAnimes.toLocaleString()}+</strong> shows loaded and ready to watch.
                </div>
            )}
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 -mt-16 relative z-10">
        ...
        {isError && (
          <div className="text-center py-20">
             <ErrorDisplay title="Failed to Load TV Shows" description={(error as any)?.message} onRetry={refetch}/>
          </div>
        )}
