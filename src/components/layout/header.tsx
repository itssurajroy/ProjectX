...
import { Search, Home, LayoutGrid, Menu, Shuffle, Rss, MessagesSquare, Calendar, Wand2, User, LogOut, Tv, Film, Star, Clock, ChevronDown, Book, Newspaper, Users } from 'lucide-react';
...
const LandingHeaderLinks = () => (
    <div className="flex items-center gap-4">
        <NavLink href="/community" className="text-gray-300 hover:text-primary"><Users className="w-5 h-5" /></NavLink>
        <NavLink href="/random" className="text-gray-300 hover:text-primary"><Shuffle className="w-5 h-5" /></NavLink>
        ...
        <NavLink href="/category/recently-added">UPDATES</NavLink>
        <NavLink href="/category/top-airing">ONGOING</NavLink>
        <NavLink href="/category/completed">RECENT</NavLink>
    </div>
);
...
export default function Header() {
  ...
  return (
    <header className={cn("fixed top-0 left-0 right-0 z-50 h-16 flex items-center transition-colors duration-300", isLandingPage ? 'bg-transparent' : 'bg-background border-b border-border')}>
